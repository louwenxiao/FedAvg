...
class download_data(object):
    ...
    def get_IID_data(self,train_num=1,test_num=1):   # 设置训练样本比例
        ...
        train_dataset = DataLoader(self.train_dataset, batch_size=self.batch_size, shuffle=True,
                                    num_workers=16,pin_memory=True)
        test_dataset = DataLoader(self.test_dataset, batch_size=self.batch_size, shuffle=True,
                                    num_workers=16,pin_memory=True)
